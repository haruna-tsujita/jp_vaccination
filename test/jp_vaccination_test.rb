...
class JpVaccinationTest < Minitest::Test
  ...
  def test_sort_recommended_schedules
    birthday = '2022-04-14'
    sort_schedules = { '2022-06-14' => ['小児用肺炎球菌 １回目', 'ヒブ １回目', 'ロタウイルス １回目', 'Ｂ型肝炎 １回目'],
                       '2022-07-14' => ['ヒブ ２回目', 'ロタウイルス ２回目', '小児用肺炎球菌 ２回目', 'Ｂ型肝炎 ２回目', '４種混合 第１期 １回目'],
                       ...
                       '2028-04-01〜2029-03-31' => ['麻しん・風しん混合 第２期', 'おたふくかぜ ２回目'],
                       '2031-04-14' => ['日本脳炎 第２期'],
                       '2033-04-14' => ['２種混合 第２期'] }
  ...
  def test_convert_to_strings
    birthday = '2020-02-29'
    sort_schedules = { Date.parse('2020-04-29') => ['小児用肺炎球菌 １回目', 'ヒブ １回目', 'ロタウイルス １回目', 'Ｂ型肝炎 １回目'],
                       Date.parse('2020-05-29') => ['ヒブ ２回目', 'ロタウイルス ２回目', '小児用肺炎球菌 ２回目', 'Ｂ型肝炎 ２回目', '４種混合 第１期 １回目'],
